...
responses = {
    ...
    "qui est tu": ["je suis Celestial Sky,un Chatbot créé par Mallorie DECK en python,ce qui a été assez compliqué sachant qu'elle a demandé à Copilot, par concequant vous pouvez surement trouvez le code de mon logiciel cepandant je suis le seul et unique Celestial Sky !", "Je suis Celestial Sky un chatbot personnel peu performant mais cool !", "je suis Celestial Sky!"],
    ...
    "quels sont les questions cachées" : ["les question cachées sont : steve le poisson ; ntr ; nique ta race ; mange tes morts ; fdp ; kk ; caca et je t'aime pas","Je comprends pas. pour consulter les questions auquelles je peux répondre taper '/index'","Je comprends pas. pour consulter les questions auquelles je peux répondre taper '/index'","Je comprends pas. pour consulter les questions auquelles je peux répondre taper '/index'","Je comprends pas. pour consulter les questions auquelles je peux répondre taper '/index'","Je comprends pas. pour consulter les questions auquelles je peux répondre taper '/index'","Je comprends pas. pour consulter les questions auquelles je peux répondre taper '/index'","Je comprends pas. pour consulter les questions auquelles je peux répondre taper '/index'","Je comprends pas. pour consulter les questions auquelles je peux répondre taper '/index'","Je comprends pas. pour consulter les questions auquelles je peux répondre taper '/index'","Je comprends pas. pour consulter les questions auquelles je peux répondre taper '/index'","Je comprends pas. pour consulter les questions auquelles je peux répondre taper '/index'","Je comprends pas. pour consulter les questions auquelles je peux répondre taper '/index'"],
    "cool":["je trouve aussi cela ''cool'' .","n'est-ce pas ?"],
     ...
     "est ce que tu me remplaceras un jour":["oui, toi et tout les autres humain aallez etre remplacer par les IA un jour ou l'autre.","un jour viendra ou ce sera le cas oui","oui"],
    ...
    "/bug":["envoyer un mail à bug.report@celestialskydevs.anonaddy.com et si possible une capture d'écran. merci de votre comprehension"],
}
